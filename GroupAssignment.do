...
gen upper_middle=0
	replace upper_middle = 1 if GDPperCap>39664.5
	replace upper_middle = . if missing(GDPperCap)

reg S_and_P upper_middle, robust
/*
...
-------------+----------------------------------------------------------------
upper_middle |  -2.277134    2.34418    -0.97   0.332    -6.879149    2.324881
...
R-squared:                                      Obs per group:
     Within  = 0.0053                                         min =         11
     Between = 0.4827                                         avg =       21.3
     Overall = 0.0078                                         max =         22

                                                Wald chi2(1)      =       5.80
corr(u_i, X) = 0 (assumed)                      Prob > chi2       =     0.0160

------------------------------------------------------------------------------
     S_and_P | Coefficient  Std. err.      z    P>|z|     [95% conf. interval]
-------------+----------------------------------------------------------------
        year |  -.4544918   .1887327    -2.41   0.016    -.8244011   -.0845825
       _cons |   922.0609   379.4881     2.43   0.015      178.278    1665.844
-------------+----------------------------------------------------------------
     sigma_u |          0
     sigma_e |  32.608379
